...
send_telegram("🚀 ADX 25→26 Momentum Screener Started")
    ...
    for symbol in symbols:
        for tf_name, tf_interval in TIMEFRAMES.items():
            try:
                ...
                # 🔥 ADX EXPANSION CONDITION
                if not (prev_adx <= 25 and curr_adx >= 26):
                    continue
                ...
                if age < 0: age = 0
                if age > FRESHNESS_LIMIT[tf_name]: continue
